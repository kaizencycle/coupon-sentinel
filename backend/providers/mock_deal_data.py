...
def get_mock_price_observations() -> List[PriceObservation]:
    ...
    return [
        ...
        PriceObservation(
            ...
            confidence=0.75,
            in_stock=None,
            documented_coupon_value=3.00,
        ),
        PriceObservation(
            id="obs-tide-rebate-feed",
            product_id="prod-tide-pods",
            upc="012345678901",
            retailer="Target",
            store_id="target-11429",
        ...
        PriceObservation(
            ...
            confidence=0.72,
            in_stock=None,
            documented_coupon_value=1.50,
        ),
        # Rebate stack support — shelf + coupon + rebate evidence
        PriceObservation(
            id="obs-chips-shelf",
...
def get_mock_deal_events() -> List[DealEvent]:
    ...
    deals = [
        ...
        build_deal_from_observations(
            ...
            observations=obs(
                ["obs-tide-receipt", "obs-tide-coupon-feed", "obs-tide-rebate-feed"]
            ),
            store_id="target-11429",
            zip_code="11429",
        ...
        build_deal_from_observations(
            ...
            observations=obs(["obs-coffee-sale", "obs-coffee-coupon-feed"]),
            store_id="walmart-11566",
            zip_code="11566",
            inventory_confirmed=True,
        ),
        ...
        build_deal_from_observations(
            ...
            observations=obs(
                ["obs-chips-shelf", "obs-chips-coupon-feed", "obs-chips-rebate-feed"]
            ),
            store_id="target-11566",
            zip_code="11566",
            inventory_confirmed=True,
